...
namespace Inspinia_MVC5
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Estilos para Datatables nuevo
            bundles.Add(new StyleBundle("~/plugins/BootstrapDatatablesNew").Include(
                      "~/Content/plugins/BootstrapDatatablesNew/bootstrap.min.css",     //Opcional
                      "~/Content/plugins/BootstrapDatatablesNew/dataTables.bootstrap.min.css",
                      "~/Content/plugins/BootstrapDatatablesNew/buttons.dataTables.min.css"
                      ));

            // Jquerys datatable nuevos
            bundles.Add(new ScriptBundle("~/plugins/JQDatatablesNew").Include(
                      "~/Scripts/plugins/JQDatatablesNew/jquery-1.12.4.js",             //Opcional
                      "~/Scripts/plugins/JQDatatablesNew/jquery.dataTables.min.js",
                      "~/Scripts/plugins/JQDatatablesNew/dataTables.bootstrap.min.js"
                      ));

            //Jquerys botones del datatables nuevos
            bundles.Add(new ScriptBundle("~/plugins/JQButtonsDatatablesNew").Include(
                      "~/Scripts/plugins/JQButtonsDatatablesNew/dataTables.buttons.min.js",
                      "~/Scripts/plugins/JQButtonsDatatablesNew/jszip.min.js",
                      "~/Scripts/plugins/JQButtonsDatatablesNew/pdfmake.min.js",
                      "~/Scripts/plugins/JQButtonsDatatablesNew/vfs_fonts.js",
                      "~/Scripts/plugins/JQButtonsDatatablesNew/buttons.html5.min.js"
                      ));
